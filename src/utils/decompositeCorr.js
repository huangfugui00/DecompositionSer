...
class Decomposite {
    ...
    getPeakCurve(mz, peakTimePosition) {
        return __awaiter(this, void 0, void 0, function* () {
            let leftIdx = 0;
    ...
    isInSameComponent(lastMz, lastTime, currMz, currTime) {
        return __awaiter(this, void 0, void 0, function* () {
            const { leftIdx: lastLeft, rightIdx: lastRight } = yield this.getPeakCurve(lastMz, lastTime);
            const { leftIdx: currLeft, rightIdx: currRight } = yield this.getPeakCurve(currMz, currTime);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (peakMz.length > 0) {
                for (let i = 1; i < peakMz.length; i++) {
                    if (Math.abs(peakTime[i] - tempPeakTime[tempPeakTime.length - 1]) < interVal && (yield this.isInSameComponent(tempPeakMz[tempPeakMz.length - 1], tempPeakTime[tempPeakTime.length - 1], peakMz[i], peakTime[i]))) {
